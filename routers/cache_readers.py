...
MOCK_NEWS_CACHE = {
    ...
    "summary": {
        "total_articles": 104,
        "sources": {"newsapi": 15, "tavily": 89},
        "sentiment": {"positive": 45, "negative": 23, "neutral": 36},
        "key_insights": [
    ...
    try:
        ...
        for symbol in portfolio_symbols:
            if symbol in latest_prices and has_real_data:
                ...
                asset_value = 125000 * allocation.get(
                    symbol, 0.1
        ...
        if not has_real_data:
            logger.warning(
                "No real LiveCoinWatch data available, using realistic mock data"
            )
            realistic_mock_data = {
                    ...
                    assets.append(
                        {
                            ...
                            "market_cap": mock_data["price"]
                            * 1000000000,  # Mock market cap
                            "technical_indicators": {
                                "rsi": 65,
                                "macd": "bullish",
        ...
        for asset in assets:
            ...
            total_change_7d += (
                asset["change_24h"] * allocation * 3
            )  # Approximate 7-day from 24h
