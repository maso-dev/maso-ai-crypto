...
class TemporalService:
    ...
    def get_processed_articles(
        self, limit: int = 50, hours_back: int = 168
    ) -> List[Dict]:
    ...
    def get_system_stats(self) -> Dict[str, Any]:
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            return {
                ...
                "processing_rate": (
                    f"{(processed/total*100):.1f}%" if total > 0 else "0%"
                ),
            }
...
async def get_optimized_news(
    limit: int = 50, hours_back: int = 168, crypto_symbols: Optional[str] = None
):
    """
    ...
    """
    try:
        articles = temporal_service.get_processed_articles(
...
async def trigger_coin_selection(
    ...
    try:
        ...
        background_tasks.add_task(webhook_trigger_coin_selection, request.dict())
