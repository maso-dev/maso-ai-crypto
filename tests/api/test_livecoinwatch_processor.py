...
async def test_livecoinwatch_processor():
    ...
    os.environ["LIVECOINWATCH_API_KEY"] = (
        "474dbae9-72de-4691-81bc-430db59ed5e3"  # Set the key
    )
    ...
    print(
        f"Processor initialized with API key: {processor.api_key[:15] if processor.api_key else 'None'}..."
    )
