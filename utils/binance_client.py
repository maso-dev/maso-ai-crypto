    ...
    try:
        ...
        for symbol, price_data in latest_prices.items():
            if price_data:
                ...
                roi_percentage = ((asset_value - asset_cost) / asset_cost * 100) if asset_cost > 0 else 0
        ...
        total_roi_percentage = ((total_value - total_cost_basis) / total_cost_basis * 100) if total_cost_basis > 0 else 0
