...
async def fetch_news_articles(terms: List[str], api_key: Optional[str] = None, hours_back: int = 24) -> List[Dict]:
    """
    ...
    async with httpx.AsyncClient() as client:
        for term in terms:
            ...
            for art in data.get("articles", []):
                ...
                hours_ago = (end_date - pub_time.replace(tzinfo=None)).total_seconds() / 3600
