...
class EnhancedContextRAG:
    ...
    async def get_portfolio_context(
        ...
        portfolio_symbols = [
            asset.asset for asset in portfolio_data.assets if asset.total > 0
        ]
    ...
    def _create_portfolio_summary(self, portfolio_data) -> Dict[str, Any]:
        ...
        assets_with_roi = [
            {
                ...
                "weight": (
                    (asset.usdt_value / total_value) * 100 if total_value > 0 else 0
                ),
            }
        ...
        return {
            ...
            "largest_positions": sorted(
                assets_with_roi, key=lambda x: x["value"], reverse=True
            )[:3],
    ...
    async def _analyze_asset_performance(self, asset) -> Optional[PortfolioInsight]:
        ...
        try:
            ...
            roi = asset.roi_percentage
            weight = (
                asset.usdt_value / 100000
            ) * 100  # Assuming 100k portfolio for weight calculation
            ...
            if roi > 50:
                ...
                description = (
                    f"{asset.asset} shows solid performance with {roi:.1f}% ROI"
                )
                ...
                description = (
                    f"{asset.asset} shows stable performance with {roi:.1f}% ROI"
                )
    ...
    async def _analyze_portfolio_composition(
        self, portfolio_data
    ) -> List[PortfolioInsight]:
            ...
            if largest_weight > 50:
                insights.append(
                    PortfolioInsight(
                        ...
                        supporting_data={
                            "largest_position": largest_position.asset,
    ...
    async def _analyze_news_sentiment(self, symbols: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            for symbol in symbols:
                symbol_news = [
                    article for article in news_data if article.get("symbol") == symbol
                ]
                ...
                if symbol_news:
                    ...
                    sentiment_analysis[symbol] = {
                        ...
                        "sentiment_score": sentiment_result.analysis_results.get(
                            "sentiment_score", 0.0
                        ),
                        "sentiment_label": sentiment_result.analysis_results.get(
                            "sentiment_label", "neutral"
                        ),
                        "key_themes": sentiment_result.analysis_results.get(
                            "key_themes", []
                        ),
                        "recent_headlines": [
                            article["title"] for article in symbol_news[:3]
                        ],
                    }
    ...
    async def _get_market_context(self, symbols: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "market_sentiment": market_analysis.analysis_results.get(
                    "sentiment", "neutral"
                ),
                "risk_factors": market_analysis.analysis_results.get("risks", []),
                "opportunities": market_analysis.analysis_results.get(
                    "opportunities", []
                ),
    ...
    async def _assess_portfolio_risk(self, portfolio_data) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "overall_risk_level": risk_analysis.analysis_results.get(
                    "risk_level", "medium"
                ),
