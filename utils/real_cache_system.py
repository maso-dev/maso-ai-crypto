...
class RealCacheSystem:
    ...
    def set(self, data_type: str, params: Dict[str, Any], data: Dict[str, Any], 
        ...
        try:
            ...
            if exists:
                ...
                cursor.execute("""
                    ...
                    VALUES (?, ?, ?, ?, ?, ?)
                """, (key, data_type, json.dumps(data), now.isoformat(), expires_at.isoformat(), now.isoformat()))
        ...
        try:
            ...
            return {
                ...
                "average_hits_per_query": (
                    (total_hits / total_queries) if total_queries and total_queries > 0 else 0
                ),
    ...
    def clear_expired(self) -> int:
        ...
        try:
            cursor.execute("DELETE FROM cache_entries WHERE expires_at <= ?", 
                         (datetime.now(timezone.utc).isoformat(),))
