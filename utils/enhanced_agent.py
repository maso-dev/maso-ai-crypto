...
from utils.news_sentiment import get_market_sentiment, get_market_context, NewsSentiment, MarketContext
...
class EnhancedAgentEngine:
    ...
    async def get_market_data(self, symbols: Optional[List[str]]) -> Dict[str, MarketData]:
            ...
            async with httpx.AsyncClient() as client:
                ...
                if response.status_code == 200:
                    ...
                    for symbol in symbols:
                        ...
                        ticker = next((t for t in tickers if t['symbol'] == f"{symbol}USDT"), None)
                        if ticker:
    ...
    async def get_news_sentiment(self, symbols: Optional[List[str]] = None) -> Optional[NewsSentiment]:
    ...
    def analyze_portfolio(self, portfolio_data: PortfolioData, market_data: Dict[str, MarketData]) -> PortfolioAnalysis:
    ...
    def _calculate_risk_score(self, portfolio_data: PortfolioData, market_data: Dict[str, MarketData]) -> float:
    ...
    async def generate_complete_analysis(self, portfolio_data: PortfolioData, symbols: Optional[List[str]] = None) -> AgentAnalysis:
    ...
    def _generate_agent_insights(self, analysis: PortfolioAnalysis, recommendations: List[Recommendation]) -> str:
...
async def generate_enhanced_agent_analysis(portfolio_data: PortfolioData, symbols: Optional[List[str]] = None) -> AgentAnalysis:
