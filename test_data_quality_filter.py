...
import asyncio
import logging
from utils.data_quality_filter import filter_news_articles, get_quality_metrics, data_quality_filter
...
async def test_data_quality_filter():
    ...
    for i, filtered_article in enumerate(filtered_articles, 1):
        ...
        print(f"   Status: {'✅ APPROVED' if filtered_article.is_approved else '❌ REJECTED'}")
