...
async def test_admin_configuration():
    ...
    try:
        ...
        print(f"✅ Configured APIs: {result.get('configured_count')}/{result.get('total_apis')}")
...
async def test_mvp_status():
    ...
    try:
        ...
        print(f"✅ Operational components: {result.get('operational_components')}/{result.get('total_components')}")
...
async def test_system_metrics():
    ...
    try:
        ...
        if 'livecoinwatch_response_time' in performance:
            print(f"✅ LiveCoinWatch response time: {performance['livecoinwatch_response_time']}s")
...
async def test_cache_statistics():
    ...
    try:
        from utils.intelligent_news_cache import get_cache_statistics, clear_expired_cache
