...
async def test_news_quality_filter():
    ...
    try:
        ...
        print(f"✅ Good article quality score: {good_result.quality_metrics.overall_score}")
        print(f"✅ Bad article quality score: {bad_result.quality_metrics.overall_score}")
...
async def test_multi_source_news():
    ...
    try:
        ...
        print(f"✅ NewsAPI results: {len(news_data.get('news_by_category', {}))} categories")
...
async def test_news_endpoint():
    ...
    try:
        ...
        print(f"✅ Quality metrics: {quality_metrics.get('filtered_articles')} filtered, {quality_metrics.get('filtered_out')} filtered out")
        print(f"✅ Average quality score: {quality_metrics.get('average_quality_score')}")
